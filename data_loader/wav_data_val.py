...
class WavDataset(Dataset):
    def __init__(self, dataset_path, bs, clip_length, val, load_test=True):
        ...
        if load_test and val==False:
            test_labels_path = "/ssd/ssd_central3/zjl/project/VAD/baselineVAD/competition_dataset/val_labels.csv"
            test_dataset_path = "/ssd/ssd_central3/zjl/project/VAD/baselineVAD/competition_dataset/val"
